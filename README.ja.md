...
4. まず、**自動ボーン割り当て**をクリックして、プラグインが対応するボーンを自動的にマッチングできるか確認できます<br>
...
6. **VRMモデルをチェック**をクリックして、すべての必須ボーンが正しく割り当てられていることを確認<br>
...
>
> ⚠️ **重要：** 表情を作成する**前に**Tポーズを完成させてください。<br>
> そうしないと、エクスポート後に表情がモデルの腕や体を壊す可能性があります。<br>
> **正しい順序：** 1. Tポーズを設定 → 2. 表情を作成<br>
...
（作成する必要があります）VRM標準の表情とビゼームを作成：（特定の命名規則に従う）
